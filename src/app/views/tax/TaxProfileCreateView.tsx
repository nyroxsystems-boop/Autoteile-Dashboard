// Tax Profile Creation/Edit Page
// Full-page form for tax settings and company details
...
export default function TaxProfileCreateView() {
    ...
    const [existingProfile, setExistingProfile] = useState<TaxProfile | null>(null);
